...
import { X, Check, Phone, CreditCard, MessageCircle } from "lucide-react";
...
export default function BookingModal({ packageTitle, price, isOpen, onClose }: BookingModalProps) {
  ...
  const advanceAmount = Math.round(price * 0.2);
                ...
                <div className="space-y-4">
                  ...
                  <button onClick={() => setStep("form")}
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-xs text-gray-500">Pay advance (20%) or full amount</p>
                    </div>
                  </button>
              ...
              {step === "form" && (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex rounded-xl bg-gray-100 p-1">
                    {[
                      { key: "advance" as const, label: `Pay Advance (20%) – ₹${advanceAmount}` },
                      { key: "full" as const, label: `Pay Full – ₹${price}` },
                    ].map((opt) => (
              ...
              {step === "success" && (
                <div className="text-center py-6">
                  ...
                  <p className="text-gray-400 text-xs mb-6">
                    Amount: ₹{displayAmount.toLocaleString("en-IN")} ({paymentType === "advance" ? "20% advance" : "Full payment"})
                  </p>
                  <p className="text-gray-400 text-xs mb-6">
